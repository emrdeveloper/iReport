...
public class Program {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JasperReport reporte = (JasperReport)JRLoader.loadObject("reporteGrafico.jasper");    
        ...
        exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new File("reporteGrafico.pdf"));     
